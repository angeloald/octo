        ...
        <div className="w-full max-w-4xl mx-auto space-y-8 text-center">
          ...
          <div className="text-center">
            <p className="text-lg text-muted-foreground mb-4">
              ...
              <code className="bg-black/[.05] dark:bg-white/[.06] px-1 py-0.5 font-semibold rounded">
          ...
          <div className="flex gap-4 items-center justify-center flex-col sm:flex-row">
            {!running && (
              <button
                onClick={startScript}
                className="border border-solid border-transparent transition-colors flex items-center justify-center bg-foreground text-background gap-2 text-sm sm:text-base h-10 sm:h-12 px-4 sm:px-5 hover:bg-yellow-500 rounded"
              >
                🤘 Run Stagehand
              </button>
            )}
            {sessionId && (
              <a
                ...
                className="border border-solid transition-colors flex items-center justify-center bg-[#F9F6F4] text-black gap-2 hover:border-[#F7F7F7] hover:text-black text-sm sm:text-base h-10 sm:h-12 px-4 sm:px-5 group rounded"
              >
            ...
            <a
              className="border border-solid border-black/[.08] dark:border-white/[.145] transition-colors flex items-center justify-center hover:bg-[#f2f2f2] dark:hover:bg-[#1a1a1a] hover:border-transparent text-sm sm:text-base h-10 sm:h-12 px-4 sm:px-5 sm:min-w-44 rounded"
          ...
          {error && (
            <div className="bg-red-400 text-white rounded-md p-2 max-w-lg mx-auto">
              Error: {error}
            </div>
          )}
          {warning && (
            <div className="bg-yellow-400 text-black rounded-md p-2 max-w-lg mx-auto">
